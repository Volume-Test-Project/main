...
public class MemberServiceImpl implements MemberService {
  ...
  public MemberDto.MemberResponse updateMemberPassword(String email, MemberDto.PutPassword memberPutPasswordDto) {
    ...
    memberValidator.verifyPrePasswordAndNewPasswordMatch(passwordEncoder.matches(memberPutPasswordDto.getPassword(), findMember.getPassword()), ExceptionCode.MEMBER_PASSWORD_NOT_CHANGE);
